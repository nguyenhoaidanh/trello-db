import { default as board } from '@/api/board';
import { default as card } from '@/api/card';
import { default as comment } from '@/api/comment';
import { default as list } from '@/api/list';
